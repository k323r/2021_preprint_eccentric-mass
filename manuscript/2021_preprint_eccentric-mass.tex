...
In this paper, we present a novel torsional coupling mechanism linking the two first modes of motion (fore-aft and side-side direction) and thus leading to the formation of orbits. 
...
In this paper, we set out to investigate this effect of \textit{torsional coupling} with a table-top experiment, finite-element simulations and a reduced order model approach. 
...
\begin{figure*}[ht]
    ...
    \caption{Position, angular velocity and absolute acceleration (left) and Lissajous figures (orbits) for the low mass scenario (right).}
    \label{fig:low-mass}
\end{figure*}
